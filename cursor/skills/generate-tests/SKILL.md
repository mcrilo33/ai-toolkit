---
name: generate-tests
description: Generate or update pytest unit and integration tests following project conventions. Use ONLY when the user explicitly asks to create tests, write tests, update tests, fix tests, sync tests with code changes, or add test coverage. Do NOT generate or modify tests proactively during code changes, refactoring, or feature implementation unless explicitly requested.
---
