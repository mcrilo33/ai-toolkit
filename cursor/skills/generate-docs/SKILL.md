---
name: generate-docs
description: Generate or update documentation including docstrings, README files, API docs, and inline comments following project conventions. Use ONLY when the user explicitly asks to document code, write docs, update docs, sync documentation, add docstrings, or fix outdated documentation. Do NOT add or modify documentation proactively during code changes, refactoring, or feature implementation unless explicitly requested.
---
...
2. **Identify** what needs documentation (functions, classes, modules)
3. **Determine** the appropriate doc format for the language
4. **Write** documentation following templates above
5. **Verify** accuracy against the code
