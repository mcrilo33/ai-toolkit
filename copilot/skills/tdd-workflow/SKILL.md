---
name: tdd-workflow
description: Guide through Test-Driven Development cycle (red-green-refactor). Use when the user wants to do TDD, write tests first, or follow the red-green-refactor pattern.
---
...
"Let's do TDD for...", "Write tests first...", "Test-driven...", "Red-green-refactor...", "I want to define behavior with tests"

**Do NOT use when:** user just wants tests after implementation (use `generate-tests` skill), or explicitly says "no TDD".
