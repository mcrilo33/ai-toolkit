---
name: source-task
description: Start a new task by fetching issue details and creating a feature branch. Use when the user says "start task", "pick up issue", or wants to begin work on a GitHub issue or ad-hoc request.
---
...
- **GitHub issue URL or number** → fetch issue details via `gh issue view <number>`
