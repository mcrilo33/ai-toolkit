...
**List sub-issues:**
Call `mcp_github_issue_read` with `method: "get_sub_issues"`, `owner`, `repo`, and `issue_number`.
...
```bash
echo '{"sub_issue_id": 12345, "after_id": 67890}' | gh api repos/{owner}/{repo}/issues/{parent_number}/sub_issues/priority -X PATCH --input -
```
